...
const Home = () => {
  return (
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl  lg:py-16 lg:px-12">
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-gray-900">Hi, I'm Rajani G N.</h1>
        <a href="#" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
            ...
            <span class="text-sm font-medium px-4 py-1.5 mr-3">Global Patent Officer at ABB eMobility</span> 
...
Driving Innovation culture through IP Training, e-Learning modules, Idea Generation/Ideation, World IP Day events, and by having Strategic partnerships with R&D Teams.</p>
        <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-left sm:space-y-0 sm:space-x-4">
            <a href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-700 hover:text-white rounded-lg bg-white hover:bg-gray-700 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                Know more about me
